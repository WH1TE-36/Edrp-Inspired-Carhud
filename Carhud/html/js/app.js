...
evaHud.CloseAyarMenu = function() {
    ...
    $.post('https://Carhud/close-ayar-menu');
};
...
window.onload = function(e) {
    ...
    $('#ghizg-on').on('change',function(){
        $.post('https://Carhud/fh4speed', JSON.stringify({status: this.checked}));
        if (this.checked) {
    ...
    $('#pusula-on').on('change',function(){
    	if(this.checked){
            ...
            $.post('https://Carhud/set-compass', JSON.stringify({compassOn: true}));
    	}
        else{
            if (pusulaAlt) {
            ...
            $.post('https://Carhud/set-compass', JSON.stringify({compassOn: false}));
        }
    });
